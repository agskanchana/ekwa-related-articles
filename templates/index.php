...
<div class="ekwa-blog-container ekwa-index-page ekwa-<?php echo esc_attr($template_design); ?>">
                    ...
                    ?>
                        <article id="post-<?php the_ID(); ?>" <?php post_class('ekwa-blog-post'); ?>>
                            ...
                            <div class="ekwa-post-footer">
                                <a href="<?php the_permalink(); ?>" class="ekwa-read-more" aria-label="Read More: <?php the_title_attribute(); ?>">
                                    Read More
